...
SEED = 0
NROWS = None
SUBMISSION_FILE = '../../Data/kaggle/house_prices/sample_submission.csv'
...
submission.to_csv('../../Data/kaggle/house_prices/sub_xgstacker_starter.sub.csv', index=None)
