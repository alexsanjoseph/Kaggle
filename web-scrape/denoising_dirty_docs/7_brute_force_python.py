...
TRAIN_DIR = Path("../../../Data/Kaggle/denoising_dirty/train/")
TARGET_DIR = Path("../../../Data/Kaggle/denoising_dirty/train_cleaned/")
TEST_DIR = Path("../../../Data/Kaggle/denoising_dirty/test/")
